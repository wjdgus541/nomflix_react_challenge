...
function LatestMovies() {
    const { data:latest, isLoading:latestLoad } = useQuery<IGetLatestMoviesResult>(
        ["movies", "latest"],
        getLatestMovies
    );
    ...
    const clickedMovie = bigMovieMatch?.params.movieId && latest?.id === +bigMovieMatch.params.movieId ? latest : null;
