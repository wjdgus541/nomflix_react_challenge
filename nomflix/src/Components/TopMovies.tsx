...
import { getTopMovies, IGetNowMoviesResult } from "../api";
...
function TopMovies() {
    ...
    const clickedMovie = bigMovieMatch?.params.movieId && top?.results.find((movie) => movie.id === +bigMovieMatch.params.movieId);
